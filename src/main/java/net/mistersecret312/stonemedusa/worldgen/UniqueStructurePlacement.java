package net.mistersecret312.stonemedusa.worldgen;
...
import net.mistersecret312.stonemedusa.init.StructurePlacementInit;
...
// Thanks to Povstalec/Woldericzjunior for existing :3
public class UniqueStructurePlacement extends RandomSpreadStructurePlacement
{
	...
	public static class Pyramid extends UniqueStructurePlacement
	{
		public static final MapCodec<Pyramid> CODEC = RecordCodecBuilder.<Pyramid>mapCodec(instance ->
				instance.group(
						ExtraCodecs.NON_NEGATIVE_INT.fieldOf("salt").forGetter(uniquePlacement -> uniquePlacement.salt())
				).apply(instance, Pyramid::new));
		
		protected Pyramid(int salt)
		{
		...
		public int getChunkOffsetX()
		{
			return MedusaConfig.pyramid_generation_x_chunk_offset.get();
		}
		
		@Override
		public int getChunkOffsetZ()
		{
			return MedusaConfig.pyramid_generation_z_chunk_offset.get();
		}
		...
		public int getChunkBoundMaxX()
		{
			return MedusaConfig.pyramid_generation_x_chunk_bounds.get();
		}
		
		@Override
		public int getChunkBoundMaxZ()
		{
			return MedusaConfig.pyramid_generation_z_chunk_bounds.get();
		}
		
		@Override
		public @NotNull StructurePlacementType<?> type()
		{
			return StructurePlacementInit.MEDUSA_PYRAMID_PLACEMENT.get();
		}
	}
}
