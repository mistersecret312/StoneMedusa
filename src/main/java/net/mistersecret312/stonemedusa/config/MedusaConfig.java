...
public class MedusaConfig
{
    ...
    public static ForgeConfigSpec.IntValue flat_activation_cost;
    ...
    public static void init(ForgeConfigSpec.Builder builder)
    {
        ...
        idle_time = builder
                .comment("The amount of time the Medusa idles after growing to full radius and before it starts to fade out, measured in ticks(20 per second)")
        ...
        generation_period = builder
                .comment("The amount of time that should pass to try generate falling Medusa's once more, in seconds, -1 to disable")
                .defineInRange("server.medusa_generation_period", 3600, -1, Integer.MAX_VALUE);
